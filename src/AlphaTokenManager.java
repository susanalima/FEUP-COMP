/* Generated By:JJTree&JavaCC: Do not edit this line. AlphaTokenManager.java */

/** Token Manager. */
public class AlphaTokenManager implements AlphaConstants
{
...
private static final int jjStopStringLiteralDfa_0(int pos, long active0)
{
   switch (pos)
   {
      ...
      case 2:
         ...
         return -1;
      case 3:
         if ((active0 & 0x1800038000L) != 0L)
            return 5;
         if ((active0 & 0x187808c2000L) != 0L)
         {
            jjmatchedKind = 42;
            jjmatchedPos = 3;
            return 5;
         ...
         return -1;
      case 4:
         if ((active0 & 0x800c0000L) != 0L)
            return 5;
         if ((active0 & 0x18700802000L) != 0L)
         {
            jjmatchedKind = 42;
            jjmatchedPos = 4;
            return 5;
...
static private int jjMoveStringLiteralDfa1_0(long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 101:
         return jjMoveStringLiteralDfa2_0(active0, 0x8000c00000L);
      case 102:
         if ((active0 & 0x4000L) != 0L)
...
static private int jjMoveStringLiteralDfa2_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 105:
         return jjMoveStringLiteralDfa3_0(active0, 0x1800060000L);
      case 108:
...
static private int jjMoveStringLiteralDfa3_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 108:
         return jjMoveStringLiteralDfa4_0(active0, 0x200042000L);
      case 110:
...
"\145\154\163\145", "\164\162\165\145", "\164\150\151\163", "\167\150\151\154\145", 
"\146\141\154\163\145", "\75", "\73", "\156\145\167", "\154\145\156\147\164\150", "\46\46", "\74", 
"\53", "\55", "\52", "\57", "\56", "\143\154\141\163\163", 
"\145\170\164\145\156\144\163", "\160\165\142\154\151\143", "\163\164\141\164\151\143", "\166\157\151\144", 
"\155\141\151\156", "\41", "\54", "\162\145\164\165\162\156", "\123\164\162\151\156\147", null, 
null, };
...
/** Constructor. */
public AlphaTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public AlphaTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
